<!--
  Phase definitions from input/phases.csv. Manish.AI
-->

# Phases (P0–P19)

| Phase | Name | Purpose | Icon | Sort key | Modules |
|-------|------|---------|------|----------|---------|
...
| P18 | Capstones | Portfolio projects | 🎓 | mc-8 | 3 |
| P19 | Certifications | Vendor credentials roadmap | 🏆 | mc-12 | 6 |

*Source: `input/phases.csv`.*
